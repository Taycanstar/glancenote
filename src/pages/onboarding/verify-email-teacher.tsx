...
const VerifyEmailTeacher: React.FC & {
  ...
  const handleResendEmail = async () => {
    if (email) {
      try {
        const response = await fetch(`${LOCAL}/resend-teacher-email/`, {
          method: "POST",
          headers: {
...
VerifyEmailTeacher.Layout = LogoLayout;
export default VerifyEmailTeacher;
